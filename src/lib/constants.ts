...
export const APP_NAME = process.env.NEXT_PUBLIC_FRAME_NAME || "baselume";
export const APP_DESCRIPTION = process.env.NEXT_PUBLIC_FRAME_DESCRIPTION || "Competitive gaming platform on Base";
